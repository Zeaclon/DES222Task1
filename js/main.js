const blurbs = {
    fear: { text: "Fear drives humans to innovate or destroy.", image: "./assets/images/fear.jpg" },
    mind: { text: "The mind is the ultimate frontier.", image: "./assets/images/head.png" }, // skull with tech implants
    overpopulation: { text: "Over Population challenges resources.", image: "./assets/images/overpopulation.jpg" },
    ...
    economy: { text: "The economy evolves alongside automation.", image: "./assets/images/economy.jpg" },
    ...
    war: { text: "War shifts into cyber realms.", image: "./assets/images/war.jpg" },
    simuology: { text: "Simuology studies the simulated realities.", image: "./assets/images/simuology.jpg" },
    simulation: { text: "Simulation experiments model societies.", image: "./assets/images/simulation.jpg" }
};
